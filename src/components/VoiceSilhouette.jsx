...
export default function VoiceSilhouette({
  ...
  size = 36,
  title,
  // When true, the SVG is treated as purely decorative (the parent element
  // is expected to carry the accessible label). This keeps the chat-strip
  // quick-switch from announcing "Feminine voice"/"Masculine voice" — those
  // are visual cues, not the voice identity we want narrated.
  decorative = false,
}) {
  if (decorative) {
    return (
